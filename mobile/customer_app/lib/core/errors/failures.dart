/// Domain-layer failure types returned by repositories / use cases.
///
/// A [Failure] is the presentation-friendly representation of an
/// [AppException]. Use cases map exceptions to failures; the controller layer
/// maps failures to a UI message (see `mapFailureToMessage`).
library;
